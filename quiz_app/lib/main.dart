...
// Add this import at the top of the file for Math.max
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Map<int, bool> _answerStatus = {}; // Track if answer was correct/incorrect
  ...
  void _selectAnswer(String answer) {
    ...
    final isCorrect = answer == currentQuestion.correctOption;
  ...
  void _retryQuestion() {
    setState(() {
      ...
      _answerStatus.remove(_currentQuestionIndex);
      _showResult = false;
      
      // If it was correct, decrease score
      if (_answerStatus[_currentQuestionIndex] == true) {
  ...
  void _continueAnyway() {
    // Just move to next question without changing anything
    _nextQuestion();
  }
  ...
  Widget _buildActionButtons(bool isCorrect) {
    if (isCorrect) {
      // For correct answers - just show continue button
      return Padding(
      ...
      // For incorrect answers - show retry and continue buttons
      return Padding(
        padding: const EdgeInsets.symmetric(vertical: 10),
        child: Row(
                      ...
                      child: Column(
                        children: [
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    leading: CircleAvatar(
                                      backgroundColor: _showResult && isCorrect 
                                          ? Colors.green 
                                          : Colors.grey[300],
                                      foregroundColor: Colors.white,
                                      child: Text(
                                    ...
                                    trailing: _showResult && icon != null
                          ...
                          if (_showResult) ...[
                            const SizedBox(height: 20),
                            Card(
                              color: _answerStatus[_currentQuestionIndex] == true
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      _answerStatus[_currentQuestionIndex] == true
                                          ? '✅ Correct! Well done!'
                                    ...
                                    if (_answerStatus[_currentQuestionIndex] == false) ...[
                                      const SizedBox(height: 8),
                                      Text(
                                        'Correct: ${_questions[_currentQuestionIndex].options[_questions[_currentQuestionIndex].correctOption]}',
                                        style: const TextStyle(
                                          fontSize: 14,
                            ...
                            _buildActionButtons(_answerStatus[_currentQuestionIndex] == true),
                          ],

                          const SizedBox(height: 20),

                          // Navigation buttons (only show when no result is shown)
                          if (!_showResult) ...[
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
